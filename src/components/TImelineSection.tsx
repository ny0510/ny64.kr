const TimelineData: { date: string; title: string; tags: string[] }[] = [
	{ date: '2024-11-01', title: '제 20회 국제특허정보박람회 부스 전시 참여', tags: ['Conference'] },
	{ date: '2024-10-29', title: '한국코드페어 SW 공모전 동상 수상', tags: ['Award'] },
	{ date: '2024-10-04', title: '리눅스마스터 2급 자격증 취득', tags: ['Certification'] },
	{ date: '2024-09-20', title: 'Gencon 2024 AI Conference for DEV 참여', tags: ['Conference'] },
	{ date: '2024-08-24', title: '제11회 대한민국 SW융합 해커톤 본선 진출', tags: ['Hackathon'] },
	{ date: '2024-08-09', title: 'JUNCTION ASIA 2024 해커톤 본선 진출', tags: ['Hackathon'] },
	{ date: '2024-04-18', title: '홈서버 CPU 업그레이드 (R7 5700X)', tags: ['HomeLab'] },
	{ date: '2023-11-09', title: '콘텐츠유니버스 코리아 테크 해커톤 본선 진출', tags: ['Hackathon'] },
	{ date: '2023-09-09', title: 'UbuCon Korea 2023 참여', tags: ['Conference'] },
	{ date: '2023-03-02', title: '선린인터넷고등학교 입학', tags: ['Education'] },
	{ date: '2023-01-07', title: 'x86 홈서버 구축 (R5 4650G)', tags: ['HomeLab'] },
	{ date: '2022-08-23', title: '우분투 CD 미러 구축', tags: ['Project'] },
	{ date: '2021-11-23', title: '개발 블로그 시작', tags: ['Project'] },
